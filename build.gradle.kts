...
base {
    archivesName.set("lerparmorstand")
}
    ...
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                name = "LerpArmorStand"
                description =
                    "A Minecraft mod that tracks and linearly interpolates armor stand rotations to deliver smooth, fluid animations."
                url = "https://github.com/kubbidev/LerpArmorStand"
                ...
                issueManagement {
                    system = "GitHub"
                    url = "https://github.com/kubbidev/LerpArmorStand/issues"
                }
            }
        }
    }
...
tasks.shadowJar {
    archiveFileName = "lerparmorstand-${projectVersion}-dev.jar"
...
val remappedShadowJar by tasks.registering(RemapJarTask::class) {
    ...
    archiveFileName = "LerpArmorStand-Fabric-${projectVersion}.jar"
}
